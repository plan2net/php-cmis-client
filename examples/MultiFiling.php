...
$propertiesFolder2 = [
    PropertyIds::OBJECT_TYPE_ID => 'cmis:folder',
    PropertyIds::NAME => 'Demo Folder 2'
];
...
try {
    ...
    $multiFillingService->addObjectToFolder($parameters[SessionParameter::REPOSITORY_ID],$document->getId(),$folder->getId());

    $multiFillingService->addObjectToFolder($parameters[SessionParameter::REPOSITORY_ID],$document->getId(),$folder2->getId());

    echo "Mutlifill done.\n";

    $multiFillingService->removeObjectFromFolder($parameters[SessionParameter::REPOSITORY_ID],$document->getId(),$folder->getId());
